...
const ProductCard = ({ product }) => {
  ...
  const handleAddToCart = (e, prodcut) => {
    e.stopPropagation();
    e.preventDefault();
...
transform transation-transform duration-300 hover:scale-105"
    >
      <img
        src={product.image}
        alt="product.name"
      ...
      <div
        class="absolute bottom-4 right-2 flex items-center justify-center 
